...
public:
	Texture();
	Texture(GLuint tex);
	Texture(GLsizei width, GLsizei height, GLenum internal, GLenum format, const GLvoid *image);
	...
	void Release()const;
	GLuint Get()const;
	GLuint LoadTexture(GLsizei width, GLsizei height, GLenum internal, GLenum format, const GLvoid *image);
